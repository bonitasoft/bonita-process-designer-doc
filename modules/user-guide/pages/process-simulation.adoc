...
* *Loop safety cap.* To avoid an endless run on a cyclic diagram, the simulation stops after a fixed number of element visits and shows a hint. Loops below that bound run normally.
