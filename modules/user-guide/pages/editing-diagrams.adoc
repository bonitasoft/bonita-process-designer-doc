...
image::editor-overview.png[The editor with the palette on the left and the canvas,800]
...
image::inspector-selected.png[An element selected on the canvas with the inspector panel open,800]
