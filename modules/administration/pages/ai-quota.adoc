...
image::admin-groups.png["A group card showing AI usage (used / limit) and the quota button",800]
image::ai-quota-dialog.png[The AI generation quota dialog for a group,800]
