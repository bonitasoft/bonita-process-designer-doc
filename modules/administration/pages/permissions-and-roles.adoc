...
| **Creator**
| Everything a Reader can do, plus create diagrams and edit or delete diagrams within the groups they belong to. A Creator can acquire the edit lock and use AI generation.
...
| Acquire edit lock | Yes | Yes | No
| Force-unlock a diagram | Yes | No | No
