...
. Set an *initial password* of at least 6 characters. You choose this password and pass it to the user; it is required.
...
image::create-user-dialog.png[The Create New User dialog,800]
