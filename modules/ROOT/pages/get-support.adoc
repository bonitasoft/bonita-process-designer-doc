= Get support
:description: What to gather before contacting the Bonitasoft Support team — the Support ID shown on an error, your product version, and the application logs — and what those logs do and do not contain.
...
Open a request with the {cscRootUrl}[Bonitasoft Support team], attaching the four items listed above.
